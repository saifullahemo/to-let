    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(roomObject.getString("roomPropertyType") != null){
            switch(roomObject.getString("roomPropertyType")){
                case "Hotel":
                    mPropertyTypeImage.setImageResource(R.mipmap.flat);
                    break;
                case "Apartment":
                    mPropertyTypeImage.setImageResource(R.mipmap.apartment);
                    break;
                case "Bachelor":
                    mPropertyTypeImage.setImageResource(R.mipmap.cottage);
                    break;
                default:
                    mPropertyTypeImage.setImageResource(R.mipmap.cottage);
                    break;
            ...
            if(amenities.get(ctr).equals(true)){
                ...
                switch (ctr){
                    case 0:
                        ...
                        features.add(new Features(R.drawable.fire, getString(R.string.add_room_bic_amenity)));
