...
public class RoomImageTwoFragment extends Fragment {
  ...
  // private RoomImageOneFragment.GetImageUrlListener mImageUrlListener;
  private ImageView mRoomImageTwo;
  /**
  ...
  public static RoomImageTwoFragment newInstance(String imageUrl) {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    //mRoomImageTwo = rootView.findViewById(R.id.details_roomimage_two);
