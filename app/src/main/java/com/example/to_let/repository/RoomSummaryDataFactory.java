...
public class RoomSummaryDataFactory extends DataSource.Factory <String, ParseObject>{
    private String roomOwner;
    public RoomSummaryDataFactory(){}
    public RoomSummaryDataFactory (String roomOwner){this.roomOwner = roomOwner;}
