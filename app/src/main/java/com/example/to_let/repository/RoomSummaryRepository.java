...
import com.example.to_let.dao.RoomSummaryDao;
...
//        mAllRooms =  roomSummaryDao.getAllRooms();
    ...
    private LiveData rooms;
    private LiveData<PagedList<ParseObject>> currentUserRooms;

    private RoomSummaryDataFactory roomSummaryDataSourceFactory;
    ...
    public LiveData<PagedList<ParseObject>> getAllRooms() {
        ...
        roomSummaryDataSourceFactory = new RoomSummaryDataFactory();
    ...
    public LiveData<PagedList<ParseObject>> getCurrentlyLoggedinUserRooms(String roomOwner) {
        ...
        roomSummaryDataSourceFactory = new RoomSummaryDataFactory(roomOwner);
